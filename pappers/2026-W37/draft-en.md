...
**Fig. 1 — The cost centre attributes extractor**, trimmed down to the lines that decide the
result: the two declarations that make it extractable, the composite key with its representative
field, and the language field cut. Names and structure are illustrative.
