...
acertaba 91.2% en Spider 1.0 y 73% en BIRD — resolvió alrededor del **20%**. Hoy
los mejores modelos rondan el **70%** en Spider 2.0-AIFunc, la extensión 2026 del benchmark
...
Business Semantics, en GA desde abril de este año. GA —disponibilidad general—
es el sello de producto terminado y soportado, con contrato detrás; lo contrario
de preview, que es "pruébalo, pero no apuestes un proyecto". Y en el Data + AI
Summit presentó Genie Ontology: una capa de contexto que aprende del uso para
