# Brújula — Edición 02 · Newsletter (paste-ready LinkedIn)

> **Cómo usar este archivo.** Todo lo que está entre `⎯⎯⎯ NEWSLETTER ⎯⎯⎯` y
> `⎯⎯⎯ FIN NEWSLETTER ⎯⎯⎯` va, tal cual, en el editor de newsletter de LinkedIn.
> Los bloques `[IMAGEN: …]` marcan dónde subir cada archivo (ya existen en esta
> carpeta). Al final hay un **post de lanzamiento** aparte para tu feed, que
> empuja tráfico a la edición.
>
> - **Portada del artículo:** `brujula-cover-02.png`
> - **Figura 1:** `fig-3-trampas.png`
> - **Figura 2:** `fig-costo-defecto.png`
...
- **Subtítulo (deck):** Por qué en un salto ECC → S/4HANA las especificaciones deciden si tus datos nacen bien
- **Portada:** `brujula-cover-02.png`
- **Tiempo de lectura estimado:** ~6 min
- **Hashtags:** #SAP #S4HANA #DataEngineering #CDSViews #CleanCore #DataMigration #BW4HANA #Arquitecturadedatos

---

⎯⎯⎯ NEWSLETTER ⎯⎯⎯

[IMAGEN: brujula-cover-02.png — portada del artículo]
...
Mi tesis, y la sostengo desde el rol de arquitecto:

**El diseño es la base del cambio, y la especificación funcional es la garantía de que la migración salga bien.** No el desarrollo. No las herramientas. El diseño. Todo lo demás ejecuta una decisión que ya se tomó —bien o mal— cuando se redactó la spec.
...
[IMAGEN: fig-3-trampas.png — Las 3 decisiones de arquitectura ocultas en 0FI_GL_10]
...
[IMAGEN: fig-costo-defecto.png — Costo de corregir un defecto según la fase (NASA)]
...
## Post de lanzamiento (para tu feed — empuja tráfico a la edición)

> Pégalo como publicación normal el mismo día que sale la edición. Adjunta
> `brujula-cover-02.png`. Deja el enlace a la newsletter en el **primer comentario**
> (LinkedIn penaliza el link en el cuerpo).
